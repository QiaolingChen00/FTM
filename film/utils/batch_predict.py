...
def main():
    ...
    # load model weights
    weights_path = r'D:\FILM_Network\film\models\film10-resnet-trial0.pth'
    ...
    with torch.no_grad():
        for ids in range(0, len(img_path_list) // batch_size):
            ...
            predict_5 = torch.stack([predict_builtup, predict_forest,predict_farmland,predict_meadow,predict_water])
        ...
        fileObject = open('image2_dict_film10.json', 'w')
