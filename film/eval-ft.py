...
def main():
    ...
    print("using {} images for validation.".format(num_test_samples))
    ...
    for num_train_per_class in [3,5,10,15,20,30,50]:
        ...
        for trial in range(5):
            ...
            pretrained_weights = torch.load(os.path.join(modelpath, "ft{}-resnet-trial{}.pth".format(num_train_per_class, trial)), map_location=device)
    ...
    rslt_file_path = os.path.join(rsltpath, 'eval-ft-resnet.pk')
