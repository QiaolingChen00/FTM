...
It finetunes the pretrained resent on the gid training set, and evaluates its performance on the validata set, 
...
def main():
    ...
    for num_train_per_class in [3,5,10,15,20,30,50]:
        for trial in range(5):
            ...
            saved_model_path = os.path.join(modelpath, 'ft{}-resnet-trial{}.pth'.format(num_train_per_class, trial))
            ...
            ####### record params
            rslt_file_path = os.path.join(rsltpath, 'records-ft{}-resnet-trial{}.pk'.format(num_train_per_class, trial))
